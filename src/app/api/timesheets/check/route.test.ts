...
describe('GET /api/timesheets/check', () => {
  ...
  it('rejects missing clientId', async () => {
    const request = createRequest('http://localhost/api/timesheets/check?month=2024-01');
  ...
  it('rejects missing month', async () => {
    const request = createRequest('http://localhost/api/timesheets/check?clientId=test-id');
